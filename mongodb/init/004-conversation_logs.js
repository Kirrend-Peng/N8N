      ...
      properties: {
        ...
        messages: {
          ...
          items: {
            ...
            additionalProperties: false,
            properties: {
              type: { enum: ["text", "image", "video", "file", "meta"], description: "訊息型別" },
              payload: { bsonType: "object", description: "依型別的內容物件" }
            }
          }
        },
        ...
        // 時間欄位
        sent_at:   { bsonType: "date", description: "訊息實際送出時間（UTC）" },
        createdAt: { bsonType: "date" },
        updatedAt: { bsonType: ["date","null"] },

        // 可選：線索追蹤
        thread_id: { bsonType: ["string","null"] },
        reply_to_id: { bsonType: ["string","null"] }
      }
    }
  },
